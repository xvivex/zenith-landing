    ...
    <nav className="fixed top-0 left-0 right-0 z-50 ">
      <div className="max-w-5xl mx-auto backdrop-blur-sm bg-gray-100/50 rounded-2xl p-4 flex justify-between items-center shadow-lg">
        ...
        <div className="flex items-center">
          <button className="flex items-center space-x-2 px-6 py-2 border border-gray-300 rounded-full text-gray-800 text-sm font-medium hover:bg-gray-200 transition-colors duration-200">
